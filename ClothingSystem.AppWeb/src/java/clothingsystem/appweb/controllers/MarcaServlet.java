...
public class MarcaServlet extends HttpServlet {
    ...
    private void doGetRequestIndex(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            Marca marca = new Marca(); // Crear una instancia  de la entidad de Rol.
            marca.setTop_aux(10); // Agregar el Top_aux con el valor de 10 a la propiedad Top_aux de marca.
            ArrayList<Marca> marcas = MarcaDAL.buscar(marca); // Ir a la capa de acceso a datos y buscar los registros de Marca.
            // El request.setAttribute se utiliza para enviar datos desde un servlet a un jsp.
            request.setAttribute("marcas", marcas); // Enviar las marcas al jsp utilizando el request.setAttribute con el nombre del atributo roles.
     ...
     * Marca , y el parámetro accion sea igual index. Este método se encargara de
     * enviar los datos de los roles al jsp de index de Marca
     *
     * @param request en este parámetro vamos a recibir el request de la
    ...
    /**
     * En este método se ejecutara cuando se envie una peticion get al servlet
     * Marca, y el parámetro accion sea igual create.
     *
     * @param request en este parámetro vamos a recibir el request de la
     * peticion get enviada al servlet Rol
     * @param response
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Obtener desde la capa de acceso a datos el marca por Id.
            Marca marca_result = MarcaDAL.obtenerPorId(marca);
            if (marca_result.getId() > 0) { // Si el Id es mayor a cero.
                // Enviar el atributo rol con el valor de los datos del marca de nuestra base de datos a un jsp
                request.setAttribute("marca", marca_result);
            } else {
                // Enviar al jsp de error el siguiente mensaje. El Id: ? no existe en la tabla de Marca
    ...
    /**
     * En este método se ejecutara cuando se envie una peticion post al servlet
     * Marca , y el parámetro accion sea igual edit.
     *
     * @param request en este parámetro vamos a recibir el request de la
     * peticion post enviada al servlet Rol
     * @param response
    ...
    /**
     * En este método se ejecutara cuando se envie una peticion post al servlet
     * Marca , y el parámetro accion sea igual delete.
     *
     * @param request en este parámetro vamos a recibir el request de la
     * peticion post enviada al servlet Rol
     * @param response
     ...
     * todas las peticiones get que se realice al Servlet Marca
     *
     * @param request en este parámetro vamos a recibir el request de la
     * peticion get enviada al servlet Rol
     * @param response en este parámetro vamos a recibir el response de la
